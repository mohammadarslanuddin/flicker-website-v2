  ...
  return (
    <section
      ...
      <div ref={panelRef} className="ln-panel" style={{ backgroundColor: "rgb(242, 240, 236)", padding: "64px 20px 20px", gap: "0px", width: "630px" }}>
        ...
        {/* Headline */}
        <h2 className="ln-headline" style={{ fontWeight: "900", letterSpacing: "-1.9px", fontSize: "42px" }}>One click away from<br />your first listen.</h2>
        ...
        <div className="ln-inner">
          ...
          <div className="ln-bookinfo">
            ...
            <div className="ln-text" ref={textRef}>
              <h3 className="ln-title" style={{ color: "rgb(33, 25, 27)", fontWeight: "900", letterSpacing: "-0.6px", fontSize: "22px" }}>The Courage to Be Disliked</h3>
